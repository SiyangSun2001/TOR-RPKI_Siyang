...
def preprocess_get_prefix_asn_local_v4():
    ...
    routeviewFile = str(pathlib.Path(__file__).parent.resolve()) + "/routeviews-rv2-20210722-0200.pfx2as"
...
def preprocess_get_prefix_asn_local_v6():
    ...
    map_dict = dict()
    quick_dict = dict()
    with open(str(pathlib.Path(__file__).parent.resolve()) + "/routeviews-rv6-20210701-1200.pfx2as") as tsv:
        count = 0
        num = '2001'
        quick_dict[num] = count
        for line in csv.reader(tsv, dialect = "excel-tab"):
